...
module.exports = {
  ...
  issueAutoRespond: {
    alreadyAssigned: {
      ...
      encouragement: 'Thanks for wanting to contribute to guidr! 💪',
    },
    assigned: {
      greeting: 'Hey @{commenter}! 👋',
  ...
  welcome: {
    firstIssue: {
      greeting: 'Welcome to the guidr community, @{commenter}! 🎉',
      ...
      encouragement: 'Thanks for helping make guidr better! 🚀',
    },
    firstPR: {
      ...
      nextSteps:
        "Our team will review your PR as soon as possible. Please ensure the build and lint checks are passing and you've linked the related issue.",
